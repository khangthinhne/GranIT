...
class LocalizationNetwork(nn.Module):
    def __init__(self, backbone_name='vit_base_patch16_clip_224.laion2b',pretrained=True, crop_size=(224,224), use_fg_afc=True, use_lhpf=True):
        super().__init__()
...
class AFC(nn.Module):
    def __init__(self, crop_size=(224,224), use_fg_afc=True, use_lhpf=True):
        super().__init__()
