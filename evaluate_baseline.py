...
if __name__ == "__main__":
    ...
    models_to_test = [
        (ResNetEvaluator, "checkpoints/resnet50_BEST_AUC.pth"),
        (EffNetB4Evaluator, "checkpoints/effnetb4_BEST_AUC.pth"),
        (XceptionEvaluator,   "checkpoints/xception_BEST_AUC.pth"),
